...
void swapsPerSecond(FILE *stream);
void comparisonsPerSecond(FILE *stream);
void memoryAllocationsPerSecond(FILE *stream);
void linearSearchesPerSecond(FILE *Stream);
void binarySearchesPerSecond( FILE *Stream );
...
void deviceCapabilitiesAnalizer(char *fileName)
{
	...
	swapsPerSecond(stream);
	comparisonsPerSecond(stream);
	memoryAllocationsPerSecond(stream);
	linearSearchesPerSecond(stream);
	binarySearchesPerSecond( stream );
